        ...
        <div className={this.props.owner}>
          ...
          <div className="col-xs-7 col-sm-9 col-md-10">
            <div className="pokeball-list">
              <Pokeballs pokemons={this.props.pokemons}
  ...
  render: function () {
    ...
    var pokeballs = this.props.pokemons.map(function (pokemon) {
      var selectedPokeball = component.state.selectedPokeball,
          activePokemon = component.props.activePokemon,
          isOpen = false;
...
var Game = React.createClass({
  ...
  generateRandomPokemons: function (list) {
    ...
    for (var index = list.length; index < 6; index++) {
  ...
  damagePokemon: function () {
    ...
    opponentPokemon.currentHp -= Math.min(component.damage(playerPokemon, opponentPokemon), opponentPokemon.currentHp);
    component.log(playerPokemon.name + ' used TACKLE');
  ...
  render: function () {
    ...
    switch (this.state.phase) {
      case 'selection':
        ...
        break;
      case 'battle':
        var currentPlayerPokemon = this.state.playerPokemons[this.state.playerPokemonIndex];
        var currentOpponentPokemon = this.state.opponentPokemons[this.state.opponentPokemonIndex];
        template = (
          <div className="container">
            <div className="row">
              <div className="col-xs-6">
